...
enum class IType
{
    ...
    Alu,
    Ld,
    St, // записать _src2Val.
    J, // записать адрес текущей инструкции увеличенный на 4.
    Jr, // записать адрес текущей инструкции увеличенный на 4.
    Br,
    Csrr, // записать _csrVal.
    Csrw, // записать _src1Val.
    Auipc // записать адрес текущей инструкции увеличенный на _imm
};

enum class BrFunc : uint8_t
{
    Eq  = 0b000, // равенство
    Neq = 0b001, // неравенство
    Lt  = 0b100, // знаковое сравнение операндов на меньше
    Ltu = 0b110, // беззнаковое сравнение операндов на меньше
    Ge  = 0b101, // знаковое сравнение операндов на больше или равно
    Geu = 0b111, // беззнаковое сравнение операндов на больше или равно
    AT, // всегда истинно
    NT, // всегда ложно
};
...
{
    Add  = 0b000,
    Sll  = 0b001, // сдвиг А на В влево, где В = Б % 32
    Slt  = 0b010, // А < Б, где А и Б считаются числами со знаком
    Sltu = 0b011, // А < Б, где А и Б считаются беззнаковыми
    Xor  = 0b100,
    And  = 0b111,
    Or   = 0b110,
    Sr   = 0b101,
    Sub  = 0b1000,
    Sra, // знаковый сдвиг А на  В вправо, где В = Б % 32
    Srl, // беззнаковый сдвиг А на В вправо, где В = Б % 32
    None,
};
